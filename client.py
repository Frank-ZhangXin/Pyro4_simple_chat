##################################################
#	
#	Final Project: Online Chat System
#	File: client.py
#	Name: Xin Zhang, Che-Wei Chen
#	Course: UTSA CS 5523 Operating System
#	Date: December 9th, 2014
#	Desc:	Implement a prototype of online chat 
#			application that consists of a Server
#			program and a Client
#			program using Java RMI or other
#			middleware.
#	Instr:	This program is writtem by Python 2.7.x.
#			Command 'python client.py' to start
#			chat client
#
##################################################
